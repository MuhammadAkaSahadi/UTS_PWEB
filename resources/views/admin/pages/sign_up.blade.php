...
<div class="h-screen md:flex">
	<div class="relative overflow-hidden md:flex w-1/2 bg-gradient-to-tr i justify-around items-center hidden">
		<div>
            <img src="{{ asset('assets/koenigsegg-agera-rsn-for-sale-makes-bugattis-seem-affordable-by-comparison-1.jpg')}}" alt="Placeholder Image" class="object-cover w-full h-full">
	...
	<div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
		<form action="contact" class="bg-white">
			...
			<button type="submit" class="block w-full bg-indigo-600 mt-4 py-2 rounded-2xl text-white font-semibold mb-2"><a href="contact">Login</a></button>
